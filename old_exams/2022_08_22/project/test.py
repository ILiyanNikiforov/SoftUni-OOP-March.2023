...
print()
print(food_orders_app.add_meals_to_shopping_cart('0899999997', **food))
print(food_orders_app.add_meals_to_shopping_cart('0899999997', **additional_food))
print(food_orders_app.finish_order("0899999997"))
print(food_orders_app)
print()
print(food_orders_app.add_meals_to_shopping_cart('0899999995', **food))
print(food_orders_app.add_meals_to_shopping_cart('0899999995', **additional_food))
print(food_orders_app.finish_order("0899999995"))
print(food_orders_app)